...
def _to_detail(payment: Payment, subscriber: Subscriber) -> PaymentDetail:
...
async def list_payments(
    ...
    return [_to_detail(p, s) for p, s in rows]
...
async def mark_payment(
    ...
    return _to_detail(payment, subscriber)
...
async def log_reminder(
    ...
    message = (
        ...
        f"₹{int(payment.amount_due)}. Please send on GPay: {upi}. Thank you! 🙏"
    )
